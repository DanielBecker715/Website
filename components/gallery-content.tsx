    ...
    <main className="relative min-h-screen bg-background text-foreground overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="border-b border-border bg-background">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 py-4 sm:py-6 flex items-center justify-between">
            <Link
              href="/"
        ...
        {/* Title */}
        <div className="mx-auto max-w-5xl px-4 sm:px-6 pt-10 sm:pt-16 pb-8 sm:pb-12">
          <ScrollReveal>
        ...
        {/* Coming Soon */}
        <div className="mx-auto max-w-5xl px-4 sm:px-6 pb-16 sm:pb-20">
